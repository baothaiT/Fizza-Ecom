...
namespace Thinh_Ecom.Migrations
{
    ...
    [Migration("20220410102537_init3")]
    partial class init3
    {
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.Bills", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            bill_DatetimeOrder = new DateTime(2022, 4, 10, 17, 25, 36, 228, DateTimeKind.Local).AddTicks(4621),
                            bill_Discount = 0,
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.Categories", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            cg_Id = "56a31666-0918-41a0-9fda-27c975a48fcb",
                            cg_Name = "Pizza",
                            cg_Sale = "",
                            cg_Type = ""
                        },
                        new
                        {
                            cg_Id = "08ba11e6-becb-4d9b-94cb-f1c24c856f29",
                            cg_Name = "Spaghetti",
                            cg_Sale = "",
                            cg_Type = ""
                        },
                        new
                        {
                            cg_Id = "6b0abe7b-1623-4556-a2a5-58d13374f273",
                            cg_Name = "Sidedishes",
                            cg_Sale = "",
                            cg_Type = ""
                        },
                        new
                        {
                            cg_Id = "968fd1ed-175e-44de-8933-ee693d99c2cf",
                            cg_Name = "Drink",
                            cg_Sale = "",
                            cg_Type = ""
                        });
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.ContactForm", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            cf_Id = "d3c0c7f9-e42a-4f54-bc1b-700eb3671736",
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.Coupons", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            couponId = "eeba2606-a0c5-4115-97fb-7422793054ce",
                        ...
                        new
                        {
                            couponId = "39cddbed-5b28-40fa-82c0-23c1fbbbae81",
                            EndTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            StartTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            couponCode = "code50",
                            couponPrice = 50
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.ProductInCart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            pic_ProductId = "39e09197-0b50-4fbb-9535-35188b07733b",
                            pic_amount = 2
                        });
                });
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.Products", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            pd_Id = "39e09197-0b50-4fbb-9535-35188b07733b",
                            CategoriesFK = "56a31666-0918-41a0-9fda-27c975a48fcb",
                        ...
                        new
                        {
                            pd_Id = "3aa9c686-b077-4c8d-9655-38561abbdc3f",
                            CategoriesFK = "56a31666-0918-41a0-9fda-27c975a48fcb",
                        ...
                        new
                        {
                            pd_Id = "981734f8-4203-421e-b176-125dc7254329",
                            CategoriesFK = "56a31666-0918-41a0-9fda-27c975a48fcb",
                        ...
                        new
                        {
                            pd_Id = "6359b7c9-1bd8-467d-842c-24bd8416e99c",
                            CategoriesFK = "56a31666-0918-41a0-9fda-27c975a48fcb",
                        ...
                        new
                        {
                            pd_Id = "41954671-db97-4e4f-9fce-45fe0a2e9142",
                            CategoriesFK = "08ba11e6-becb-4d9b-94cb-f1c24c856f29",
                        ...
                        new
                        {
                            pd_Id = "71d336f3-aeef-48f7-b5d2-b07c73281d57",
                            CategoriesFK = "08ba11e6-becb-4d9b-94cb-f1c24c856f29",
                        ...
                        new
                        {
                            pd_Id = "d5e4a170-b154-4dc3-b89a-4cdf9465e583",
                            CategoriesFK = "6b0abe7b-1623-4556-a2a5-58d13374f273",
                        ...
                        new
                        {
                            pd_Id = "0db60636-640d-4f7c-9199-f7d2d4f40562",
                            CategoriesFK = "56a31666-0918-41a0-9fda-27c975a48fcb",
                        ...
                        new
                        {
                            pd_Id = "c66679b2-8235-4672-8418-47be10226b20",
                            CategoriesFK = "56a31666-0918-41a0-9fda-27c975a48fcb",
                        ...
                        new
                        {
                            pd_Id = "354e5b23-70cf-44d5-9c76-b755a3a59d7e",
                            CategoriesFK = "56a31666-0918-41a0-9fda-27c975a48fcb",
                        ...
                        new
                        {
                            pd_Id = "63d8a3f3-57b9-49b5-860c-7f608e4dfdb0",
                            CategoriesFK = "56a31666-0918-41a0-9fda-27c975a48fcb",
                        ...
                        new
                        {
                            pd_Id = "4b3e811f-be28-4538-a314-2d5fe816afa1",
                            CategoriesFK = "56a31666-0918-41a0-9fda-27c975a48fcb",
                        ...
                        new
                        {
                            pd_Id = "8e2537d8-9072-478d-afe3-d6df2fc6efba",
                            CategoriesFK = "56a31666-0918-41a0-9fda-27c975a48fcb",
                        ...
                        new
                        {
                            pd_Id = "5751f872-4bac-4045-b371-8688e04c4317",
                            CategoriesFK = "56a31666-0918-41a0-9fda-27c975a48fcb",
                        ...
                        new
                        {
                            pd_Id = "86db3b5b-9448-435e-a47a-c4c44c456eb5",
                            CategoriesFK = "56a31666-0918-41a0-9fda-27c975a48fcb",
                        ...
                        new
                        {
                            pd_Id = "6790954b-34ce-4dc4-a658-5c768b4a1df4",
                            CategoriesFK = "08ba11e6-becb-4d9b-94cb-f1c24c856f29",
                            pd_Description = "pizza-bo",
                            pd_Img1 = "/img/pizza-300x300/pizza-bo.png",
                            pd_Img2 = "",
                        ...
                        new
                        {
                            pd_Id = "4c156902-ceb8-4097-b906-cd3a7bdcaa77",
                            CategoriesFK = "6b0abe7b-1623-4556-a2a5-58d13374f273",
                        ...
                        new
                        {
                            pd_Id = "11d9d8d6-ad8e-40bb-8a3f-4f04f7837860",
                            CategoriesFK = "968fd1ed-175e-44de-8933-ee693d99c2cf",
            ...
            modelBuilder.Entity("Thinh_Ecom.EntitiesThinh_Ecom.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "4aaa69e3-6ffe-4a0e-8bec-679b1d3970a9",
                            Name = "staff",
                            Description = "Staff"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "ef496c2a-bbc3-4d5e-a4d9-ac523922ad53",
                            Name = "admin",
                            Description = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "71bffca9-0f6b-4826-964c-b85a5931e7f2",
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEHcihIfTLFPc4EdSgUKoLC0ncLLPYk2bvLe1IXRRGppcF9YhzCTYib+DeCIK42PyiQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "31d51914-793a-4619-affb-00bfb043bf17",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c1b40ac5-0b08-4d0c-997f-3ae07a815760",
                            Email = "staff@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "STAFF@GMAIL.COM",
                            NormalizedUserName = "STAFF@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEBZdMGHnd9y2GYmgR26dOt0R0AcHMl3WBNn6WRGNQ/ANrc7DjrlWhZ1hDh7BAImrsA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "fdeb0bce-dd5a-48a9-9db4-16e653c69fc6",
                            TwoFactorEnabled = false,
                            UserName = "Staff",
