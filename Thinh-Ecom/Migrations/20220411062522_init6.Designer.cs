...
namespace Thinh_Ecom.Migrations
{
    ...
    [Migration("20220411062522_init6")]
    partial class init6
    {
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.Bills", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            bill_DatetimeOrder = new DateTime(2022, 4, 11, 13, 25, 21, 782, DateTimeKind.Local).AddTicks(6655),
                            bill_Discount = 0,
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.Categories", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            cg_Id = "53151c35-365b-486c-befc-daf15ac592a7",
                            cg_Name = "Pizza",
                            cg_Sale = "",
                            cg_Type = ""
                        },
                        new
                        {
                            cg_Id = "d0a5100b-a7e7-4408-bc3e-90c59813ec96",
                            cg_Name = "Spaghetti",
                            cg_Sale = "",
                            cg_Type = ""
                        },
                        new
                        {
                            cg_Id = "12e9fcb8-88e6-4ce4-9511-224469d00f7c",
                            cg_Name = "Sidedishes",
                            cg_Sale = "",
                            cg_Type = ""
                        },
                        new
                        {
                            cg_Id = "43c750b7-3c5e-4dd3-95b0-0761270c2450",
                            cg_Name = "Drink",
                            cg_Sale = "",
                            cg_Type = ""
                        });
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.ContactForm", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            cf_Id = "dc3cf721-5d6b-48e7-be06-3259829494c9",
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.Coupons", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            couponId = "ad725743-05e4-4405-b864-f1d4c032dce1",
                        ...
                        new
                        {
                            couponId = "b4d88c37-16cd-4f5b-aaad-fc7fd3e5ce61",
                            EndTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            StartTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            couponCode = "code50",
                            couponPrice = 50
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.ProductInCart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            pic_ProductId = "b39b0d95-f680-48ec-9d42-512590e80d5f",
                            pic_amount = 2
                        });
                });
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.Products", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            pd_Id = "b39b0d95-f680-48ec-9d42-512590e80d5f",
                            CategoriesFK = "53151c35-365b-486c-befc-daf15ac592a7",
                        ...
                        new
                        {
                            pd_Id = "f8331e99-8022-45b1-95e5-09587c28df8f",
                            CategoriesFK = "43c750b7-3c5e-4dd3-95b0-0761270c2450",
                        ...
                        new
                        {
                            pd_Id = "9f028af3-17db-41c5-ba7b-a9b739f58c72",
                            CategoriesFK = "53151c35-365b-486c-befc-daf15ac592a7",
                        ...
                        new
                        {
                            pd_Id = "14a9999c-ac52-45d5-96e6-ca81ab31361b",
                            CategoriesFK = "43c750b7-3c5e-4dd3-95b0-0761270c2450",
                        ...
                        new
                        {
                            pd_Id = "10084160-6eca-49cf-a267-d35d10bc70fe",
                            CategoriesFK = "53151c35-365b-486c-befc-daf15ac592a7",
                        ...
                        new
                        {
                            pd_Id = "8f74be5e-4dad-4e82-838d-f5aaf598d81c",
                            CategoriesFK = "53151c35-365b-486c-befc-daf15ac592a7",
                        ...
                        new
                        {
                            pd_Id = "96627aa5-f239-43d4-bfb6-e662fd258961",
                            CategoriesFK = "12e9fcb8-88e6-4ce4-9511-224469d00f7c",
                        ...
                        new
                        {
                            pd_Id = "ba6c552d-58de-4c34-adef-30e93f3c6472",
                            CategoriesFK = "d0a5100b-a7e7-4408-bc3e-90c59813ec96",
                        ...
                        new
                        {
                            pd_Id = "9de4ab4c-5835-434b-bb9b-9e3771d8c84a",
                            CategoriesFK = "53151c35-365b-486c-befc-daf15ac592a7",
                        ...
                        new
                        {
                            pd_Id = "14771e82-6763-41ab-b2d7-0ec544f0c5fd",
                            CategoriesFK = "53151c35-365b-486c-befc-daf15ac592a7",
                        ...
                        new
                        {
                            pd_Id = "d829ea36-0dd5-4597-9f06-76f609dc9e0b",
                            CategoriesFK = "53151c35-365b-486c-befc-daf15ac592a7",
                        ...
                        new
                        {
                            pd_Id = "a4e1104a-2e61-4682-8fb7-45983344a2d0",
                            CategoriesFK = "53151c35-365b-486c-befc-daf15ac592a7",
                        ...
                        new
                        {
                            pd_Id = "939c9725-b2d9-4dde-aae0-7c9206eb6498",
                            CategoriesFK = "53151c35-365b-486c-befc-daf15ac592a7",
                        ...
                        new
                        {
                            pd_Id = "e9289eca-97e2-4873-807c-e74eaa2e5917",
                            CategoriesFK = "53151c35-365b-486c-befc-daf15ac592a7",
                        ...
                        new
                        {
                            pd_Id = "3a7d5287-2555-4d79-9e7d-8fd6e42ea1c8",
                            CategoriesFK = "d0a5100b-a7e7-4408-bc3e-90c59813ec96",
                        ...
                        new
                        {
                            pd_Id = "624866b9-c04a-4e7e-af10-debf2b3097c6",
                            CategoriesFK = "d0a5100b-a7e7-4408-bc3e-90c59813ec96",
                            pd_Description = "pizza-bo",
                            pd_Img1 = "/img/pizza-300x300/pizza-bo.png",
                            pd_Img2 = "",
                        ...
                        new
                        {
                            pd_Id = "dd46a709-bb57-4e9f-ae66-c323d6580fa0",
                            CategoriesFK = "12e9fcb8-88e6-4ce4-9511-224469d00f7c",
                        ...
                        new
                        {
                            pd_Id = "c1ef5d85-11e4-47e4-9947-131c0dd1a147",
                            CategoriesFK = "43c750b7-3c5e-4dd3-95b0-0761270c2450",
            ...
            modelBuilder.Entity("Thinh_Ecom.EntitiesThinh_Ecom.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "d70f0079-bccb-4343-bf5d-15980bbd3c8c",
                            Name = "staff",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "6eb3c297-7af9-4e53-9411-282c12ee32bb",
                            Name = "admin",
            ...
            modelBuilder.Entity("Thinh_Ecom.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "aa291f8d-9119-4c2e-8260-8bb32dcef31c",
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEHVN/ig6y/8Ap2RvZvrZ3jRKdMZllQw4Ba6+lHp1URvKKZSeEGuM2go1K4mVzhPIhw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "5f9535bc-3786-4876-96b7-1c2865468e8c",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e14f1916-6717-4378-aead-ab0adc6556d3",
                            Email = "staff@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "STAFF@GMAIL.COM",
                            NormalizedUserName = "STAFF@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEMvdlPP41qXpTlgaWHBSZknVtMzRV7Kel4WiJkd7Xl3/CZAY7I8bAkDmVN8ceX3FMw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "50f9c57a-59b0-4734-83be-6a64680f6d15",
                            TwoFactorEnabled = false,
                            UserName = "Staff",
